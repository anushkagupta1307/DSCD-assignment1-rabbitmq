        ...
        while (n != 6) {
            ...
            switch (n) {
                ...
                case 4:
                    ...
                    if(client2_serversList.contains(server_name_getarticle)){
                        ...
                        if(server_name_getarticle.equals("queueB"))
                            urlappend="server1";
                        else if(server_name_getarticle.equals("queueE"))
                            urlappend="server2";
                ...
                case 5:
                    ...
                    publishArticleRequest.setClient_id(2);
